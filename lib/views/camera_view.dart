    ...
    return Container(
      ...
      child: Stack(
        ...
        children: <Widget>[
          ...
          _backButton(),
          _instructionText(widget.instructionText, widget.circleColor),
        ],
      ),
    );
  }

  Widget _instructionText(String text, Color color) => Row(
          ...
          Container(
              ...
              child: Text(
                ...
                style: const TextStyle(
                    color: ColorName.secondaryLight, fontSize: Sizes.space20),
              )),
        ],
      );
